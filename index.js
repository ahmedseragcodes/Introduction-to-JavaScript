...
function annoyingSong(count){
  ...
  return(`${count} bottles of soda on the wall, ${count} bottles of soda, take one down pass it around ${newCount} bottles of soda on the wall`);
  }
